...
function TrackPage({ time_range, allTracks, spotifyApi }) {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen text-white bg-gradient-to-br from-zinc-800 to-zinc-950">
      ...
      <form
        className="fixed top-1/2 transform -translate-y-1/2 bg-zinc-800 text-white font-semibold py-6 px-8 rounded-md shadow-2xl w-80 transition-transform duration-300 ease-in-out hover:scale-105"
      ...
      >
        <div className="w-full h-16 bg-[#1db954] text-white flex items-center justify-center rounded-lg px-4 mb-3">
